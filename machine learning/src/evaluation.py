...
import torch
from sklearn.metrics import classification_report, f1_score, recall_score, precision_score, recall_score, confusion_matrix
...
class Evaluation:
    ...
    def evaluate(self, model, device, epoch):
        ...
        for batch in tqdm(self.evaluation_data_loader, desc="Evaluating", position = 0, leave = True):
            model.eval()
